...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // You would integrate with EmailJS or Formspree here
    alert("Message sent successfully!")
  }

  return (
    <section id="contact" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-[rgb(0,0,18)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Form */}
                      <Card ref={formRef} className="border-0 shadow-lg bg-white dark:bg-[rgb(0,0,18)]">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="lastName" placeholder="last name" required className="border-gray-300 dark:border-gray-600" />
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white font-medium">pshah88669@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white font-medium">+91 8866978122 </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white font-medium">Pune, Maharashtra</p>
                    </div>
                  </div>
                </div>
              </CardContent>
